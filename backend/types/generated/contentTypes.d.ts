...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog articles and shopping guides';
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Product/Deal categories';
...
export interface ApiCouponCoupon extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Coupon and deal information';
    displayName: 'Coupon';
    pluralName: 'coupons';
    singularName: 'coupon';
  };
  ...
  attributes: {
    ...
    discount_type: Schema.Attribute.Enumeration<
      ['percentage', 'fixed', 'free_shipping', 'bogo', 'unknown']
    > &
      Schema.Attribute.DefaultTo<'unknown'>;
    discount_value: Schema.Attribute.Decimal;
    expires_at: Schema.Attribute.DateTime;
    is_expired: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiImportJobImportJob extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Bulk import jobs for stores and coupons';
  ...
  attributes: {
    ...
    format: Schema.Attribute.Enumeration<
      ['csv', 'xlsx', 'json', 'google_sheet']
    > &
      Schema.Attribute.DefaultTo<'csv'>;
    imported_count: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    is_auto_sync: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    total_rows: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    type: Schema.Attribute.Enumeration<['stores', 'coupons']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
